...
<html>
<head>
    <title>Green Wheels | Guide Registration</title>
...
<div class="header">
	<div class="container">
		...
		<div class="bus wow fadeInUp animated" data-wow-delay=".5s">
            <a href="index.html" class="buses active">TRANSPORT</a>
            <a href="hotels.html">HOTELS</a>
            <a href="hotels.html">GUIDE PERSONS</a>
...
<div class="agent">
	<div class="container">
		<div class="col-md-6 agent-left wow fadeInDown animated" data-wow-delay=".5s">
			...
			<form action="src/guide_registration.php" method="post">
